...
<head>
   <meta charset="UTF-8">
   <title>Direct Post Sale 3D</title>
</head>
<script type="text/javascript">
   function randomString(length, chars) {
	...
	function generateRandomData() {
	  document.getElementById('cardOwner').value = 'Cust-' + randomString(8, "aA#");
...
<body onload="generateRandomData()">
   <div class="container">
      <h2>Direct Post Sale 3D</h2>
	  <h4><a href="http://localhost:8090/paratikasamples/jsp/session/sessiontoken.jsp">You need to create a session token and paste it below</a></h4>
      <form method="post" id="formUrl" action="https://test.paratika.com.tr/paratika/api/v2/post/sale3d/SESSIONTOKEN">
         <table>
            <tr>
            ...
            <tr>
               <td>Url:</td>
               <td><input style="width:580px;" type="text" id="f1" value="https://test.paratika.com.tr/paratika/api/v2/post/sale3d/SESSIONTOKEN" /></td>
               <td>
